...
class transEmeta(Model):
    def __init__(self, config):
        super(transEmeta, self).__init__(config)
    ...
    def init_weights(self):
        ...
        # tencent_init
        self.pre_ent_embeds = self.config.ent_embeddings
        self.pre_rel_embeds = self.config.rel_embeddings
        self.ent_embeddings.weight = nn.Parameter(torch.Tensor(self.pre_ent_embeds))
        self.rel_embeddings.weight = nn.Parameter(torch.Tensor(self.pre_rel_embeds))
