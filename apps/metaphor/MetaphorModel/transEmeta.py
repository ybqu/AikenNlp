...
class transEmeta(Model):
    def __init__(self, config):
        ...
        # self.tar_sim_matrix = nn.Parameter(torch.randn(self.rel_size, self.rel_size))
        # self.sour_sim_matrix = nn.Parameter(torch.randn(self.rel_size, self.rel_size))
    ...
    def init_weights(self):
        ...
        # self.tar_sim_matrix.requires_grad = False
        # self.sour_sim_matrix.requires_grad = False
